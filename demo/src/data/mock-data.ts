import type { MessageFile, MessageReactions, RoomUser } from '@artesa/vue-advanced-chat'
...
export interface SeedMessage {
	...
	replyMessage?: { _id: string, content: string, senderId: string }
	edited?: boolean
	deleted?: boolean
	files?: MessageFile[]
}
...
export const messagesByRoom: Record<string, SeedMessage[]> = {
	'room-1': [
		{
			_id: 'msg-1-1',
		...
		},
		{
			...
			reactions: { '\u{1F44D}': ['SGmFnBZB4xxMv9V4CVlW'] },
		},
		{
			_id: 'msg-1-4',
			senderId: 'SGmFnBZB4xxMv9V4CVlW',
	...
	'room-2': [
		...
		},
		{
			...
			reactions: {
				'\u{1F525}': ['6R0MijpK6M4AIrwaaCY2'],
				'\u{1F4AF}': ['6R0MijpK6M4AIrwaaCY2'],
			},
		},
		{
			_id: 'msg-2-4',
